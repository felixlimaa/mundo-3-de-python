...
print(f"{'-'*50}")
q = int(input("Quantos jogos você quer que eu sorteie? ")) #3 [[6 numeros], [6 numeros], [6 numeros]]
...
#print(f"t: {t}")
for i in range(0,len(t)):
    t[i].sort() #Ainda tem bugs de numeros fora de ordem. Usando para facilitar e seguir com os treinos.
    n.append(t[i])
#print(t)
for i in range(0,len(n)):
    print(f"Jogo {i+1}: {n[i]}")
    sleep(2)
t.clear()
#print("t: ",t)